...
//	Out:	なし
//------------------------------------------------------
CTimeOverLogo::CTimeOverLogo(LPDIRECT3DDEVICE8 d3dDevice, LPDIRECT3DTEXTURE8 pTexture)
		   :CListSprite(d3dDevice, pTexture)
{
	...
	/* テクスチャ表示位置の設定 */
	C2DGraphicObj::SetRec( 0, 0, 512, 128);
